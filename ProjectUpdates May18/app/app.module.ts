...
const appRoutes : Routes = [
  ...
  {path:'studentshow',component:StudentShowComponent,outlet:'data'},
...
//   {path:'studentshow',component:StudentShowComponent},
//   {path:'employdropdown',component:EmploydropdownComponent},
//   {path:'studentdropdown',component:StudentdropdownComponent},
